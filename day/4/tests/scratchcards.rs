...
fn test_example_card_2() {
    let card: Card = Card::from("Card 2: 13 32 20 16 61 | 61 30 68 82 17 32 24 19").expect("REASON");
...
fn test_example_card_3() {
    let card: Card = Card::from("Card 3:  1 21 53 59 44 | 69 82 63 72 16 21 14  1").expect("REASON");
...
fn test_example_card_4() {
    let card: Card = Card::from("Card 4: 41 92 73 84 69 | 59 84 76 51 58  5 54 83").expect("REASON");
...
fn test_example_card_5() {
    let card: Card = Card::from("Card 5: 87 83 26 28 32 | 88 30 70 12 93 22 82 36").expect("REASON");
...
fn test_example_card_6() {
    let card: Card = Card::from("Card 6: 31 18 13 56 72 | 74 77 10 23 35 67 36 11").expect("REASON");
